...
public class DeleteProduct {
	...
	public String deletionProductName = "Ear Ring";
	...
	public void setUp() throws Exception {
		...
		extent = new ExtentReports("./TestReports/DeleteProduct.html");
	...
	public void deleteCatagory()  {
	    ...
	    extentTest = extent.startTest("Filter for a product,delete and validate the deletion alert");
	    productsPOM.filterProductAndDelete(deletionProductName);
	    ...
	    extentTest = extent.startTest("Validate the message on banner on product deletion");
